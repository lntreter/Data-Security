...
const Drawer = () => {
    ...
    return (
        ...
        <div className="flex ">
            ...
            <label htmlFor="drawer-toggle" className="absolute top-0 left-0 inline-block p-4 transition-all duration-1000 bg-indigo-500 rounded-lg peer-checked:rotate-180 peer-checked:left-64">
